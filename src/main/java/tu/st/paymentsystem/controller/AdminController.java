...
public class AdminController {
    ...
    public ResponseEntity addStudent(@RequestBody final StudentDTO studentDTO){
        final Student student = new Student(studentDTO.getFirstName(), studentDTO.getLastName(), studentDTO.getBoardingHouse(), studentDTO.getFacultyId(),
    ...
    public List<PaymentEventDTO> checkStudent(@PathVariable final Long facultyId){
        final List<PaymentEvent> events = adminService.checkStudentStatus(facultyId);
